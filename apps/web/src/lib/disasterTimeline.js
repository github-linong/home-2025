...
export const DISASTER_TIMELINE_EVENTS = [
  ...
  },
  {
    ...
    event: "领地联盟成立",
    impact:
      "制定共同规则；隐蔽山谷与养殖支点落地；大宗作物规模化；引入颐石防护抗戕雨。人类侧长期协作含匡庆威（货讯）、齐富（种田）、时舯（农具）、赵泽（四号邻地）、辛瑜（陨铁换武）、唐怀（后勤／听觉）等",
  },
  {
    era: "story",
    yearLabel: "约114章",
  ...
  },
  {
    ...
    event: "第九种植中心",
    impact: "种子推广主阵地成型：实验室成果转可推广种质（发芽率、二元素稳定、攻击性戕进化比率）；农业现代化与安全区粮食升级提速",
  },
  {
    era: "story",
    yearLabel: "中后期",
