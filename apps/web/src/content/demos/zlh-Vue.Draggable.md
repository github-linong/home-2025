...
description: "list: 统计: / 8 . => /8"
pubDate: "2019-06-01"
type: web
demoUrl: "/demos/html/zlh-Vue.Draggable.html"
legacyUrl: "/static/html/zlh-Vue.Draggable.html"
category: "实验"
badge: "精选"
tags: ["legacy", "实验", "精选"]
---
...
1. 拖动列表项改变顺序，确认 Vue 数据同步。
2. 若有多列，尝试跨列表拖拽。
3. 移动端长按拖动，检查滚动冲突。
4. 在控制台打印绑定数组，确认索引更新正确。
