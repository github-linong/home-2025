var raw = require('./raw') // {Decrypt as RawDecrypt} from "./raw";
var RawDecrypt = raw.Decrypt
var util = require('./util') // {GetArrayBuffer} from "./util";
GetArrayBuffer = util.GetArrayBuffer
