...
exports.FLAC_HEADER = FLAC_HEADER

const MP3_HEADER = [0x49, 0x44, 0x33];
exports.MP3_HEADER = MP3_HEADER

const OGG_HEADER = [0x4F, 0x67, 0x67, 0x53];
exports.OGG_HEADER = OGG_HEADER

const M4A_HEADER = [0x66, 0x74, 0x79, 0x70];
exports.M4A_HEADER = M4A_HEADER

const WMA_HEADER = [
    0x30, 0x26, 0xB2, 0x75, 0x8E, 0x66, 0xCF, 0x11,
    0xA6, 0xD9, 0x00, 0xAA, 0x00, 0x62, 0xCE, 0x6C,
]
exports.WMA_HEADER = WMA_HEADER

const WAV_HEADER = [0x52, 0x49, 0x46, 0x46]
exports.WAV_HEADER = WAV_HEADER
...
exports.AudioMimeType = AudioMimeType
...
function GetFileInfo(artist, title, filenameNoExt, separator = "-") {
 ...
 * @return {string}
 */
function GetMetaCoverURL(metadata) {
    let pic_url = "";
...
function IsBytesEqual(first, second) {
 ...
 * @return {string}
 */
function DetectAudioExt(data, fallbackExt) {
...
async function GetWebImage(pic_url) {
    try {
...
async function WriteMp3Meta(audioData, artistList, title, album, pictureData = null, pictureDesc = "Cover") {
...
function RequestJsonp(url, callback_name = "callback") {
...
exports.GetMetaCoverURL = GetMetaCoverURL
exports.IsBytesEqual = IsBytesEqual
exports.DetectAudioExt = DetectAudioExt
exports.GetWebImage = GetWebImage
exports.WriteMp3Meta = WriteMp3Meta
