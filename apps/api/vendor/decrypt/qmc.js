var  {AudioMimeType, DetectAudioExt, GetArrayBuffer, GetFileInfo, GetMetaCoverURL, RequestJsonp} =require( "./util");
var  {QmcMaskCreate58, QmcMaskDetectMflac, QmcMaskDetectMgg, QmcMaskGetDefault} =require( "./qmcMask");


// var  {fromByteArray as Base64Encode, toByteArray as Base64Decode} from 'base64-js'
var base64js = require('base64-js');
var Base64Encode = base64js.fromByteArray;
var Base64Decode = base64js.toByteArray;
...
async function Decrypt(file, raw_filename, raw_ext) {
    ...
    // console.log(musicDecoded)

    // let musicBlob = new Blob([musicDecoded], {type: mime});
    // console.log(musicDecodedmusicDecoded)
    // console.log(musicDecoded.buffer)
    const musicMeta = await musicMetadata.parseBuffer(Buffer.from(musicDecoded.buffer))
